...
export const routes: RouteItems[] = [
  ...
  },
  {
    ...
    pages: [
        ...
        pages: [
          {
            ...
            active: true,
            path: 'analogy/designations/all-designations',
            pathName: 'all-designations'
          },
          {
            name: 'Add Designations',
            active: true,
            path: 'analogy/designations/add-designations',
            pathName: 'add-designations'
          }
        ]
      }
      // {
      ...
      //       name: 'All Roles',
      //       active: true,
      //       path: 'analogy/roles/all-roles',
      //       pathName: 'all-roles',
      //     },
      //     {
      //       name: 'Add Roles',
      //       active: true,
      //       path: 'analogy/roles/add-roles',
      //       pathName: 'add-roles',
      //     },
      ...
      //       active: true,
      //       path: 'analogy/qualification/all-qualification',
      //       pathName: 'all-qualification',
      //     },
      ...
      //       active: true,
      //       path: 'analogy/credentials/all-credentials',
      //       pathName: 'all-credentials',
      //     },
      ...
      //       name: 'All Salary',
      //       active: true,
      //       path: 'analogy/salary/all-salary',
      //       pathName: 'all-salary',
      //     },
      ...
      //       name: 'All Address',
      //       active: true,
      //       path: 'analogy/address/all-address',
      //       pathName: 'all-address',
      //     },
